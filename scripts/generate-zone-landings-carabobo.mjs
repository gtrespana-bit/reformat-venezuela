...
// ═══════════════════════════════════════════
// SERVICES (same structure as generate-zone-landings.mjs)
// ═══════════════════════════════════════════
const services = [
  {
...
// ═══════════════════════════════════════════
// NEW ZONES — Carabobo (near San Diego HQ)
// ═══════════════════════════════════════════
const zones = [
  {
    slug: 'naguanagua',
    ...
    city: 'Valencia',
    citySlug: 'valencia',
    neighborhoods: 'Mañongo, La Campiña, El Retobo y Caprenco',
    description: 'Remodelaciones en Naguanagua, Carabobo. Expertos en apartamentos y casas en Mañongo, La Campiña, El Retobo y todo el municipio.',
    localInsight: 'Naguanagua es uno de los municipios con mayor crecimiento residencial de Carabobo. Combinamos experiencia en edificios de Mañongo (con normativas de condominio estrictas) y casas unifamiliares en zonas como La Campiña y El Retobo. Estamos a menos de 15 minutos de nuestra base en San Diego.',
  },
  {
    slug: 'el-trigal',
    name: 'El Trigal',
    city: 'Valencia',
    citySlug: 'valencia',
    neighborhoods: 'El Trigal Norte, El Trigal Sur y La Alegría',
    description: 'Remodelaciones en El Trigal, Valencia. Urbanización premium con apartamentos y casas de alto estándar.',
    localInsight: 'El Trigal es una de las urbanizaciones más exclusivas de Valencia, con viviendas de 120-300 m² y altos estándares de acabado. Las remodelaciones aquí exigen materiales premium, diseños de autor y cumplimiento estricto de normativas de condominio. Nuestro equipo conoce los edificios y townhouses de la zona.',
  },
  {
    slug: 'la-trigalena',
    name: 'La Trigaleña',
    city: 'Valencia',
    citySlug: 'valencia',
    neighborhoods: 'La Trigaleña Norte, La Trigaleña Sur y El Parral',
    description: 'Remodelaciones en La Trigaleña, Valencia. Zona residencial consolidada con casas y apartamentos.',
    localInsight: 'La Trigaleña es una zona residencial madura con viviendas de 20-40 años que requieren actualización integral de instalaciones y acabados. Las casas unifamiliares predominan, con amplios espacios que permiten redistribuciones ambiciosas. Conocemos las tipologías constructivas de la zona.',
  },
  {
    slug: 'guacara',
    name: 'Guacara',
    city: 'Guacara',
    citySlug: 'valencia',
    neighborhoods: 'Ciudad Alianza, El Samán, La Florida y Yuma',
    description: 'Remodelaciones en Guacara, Carabobo. Casas, townhouses y apartamentos en Ciudad Alianza, El Samán y todo el municipio.',
    localInsight: 'Guacara ha experimentado un boom residencial con urbanizaciones como Ciudad Alianza y El Samán. Las viviendas nuevas suelen requerir personalización de acabados, mientras que las de 10-15 años necesitan actualización de cocinas y baños. Atendemos todo el municipio desde nuestra base en San Diego.',
  },
  {
    slug: 'los-guayos',
    name: 'Los Guayos',
    city: 'Los Guayos',
    citySlug: 'valencia',
    neighborhoods: 'La Isabelica, El Roble, Los Guayos Centro y Paraparal',
    description: 'Remodelaciones en Los Guayos, Carabobo. Municipio contiguo a San Diego con viviendas residenciales y comerciales.',
    localInsight: 'Los Guayos es municipio contiguo a San Diego, lo que nos permite tiempos de respuesta muy rápidos. La zona combina viviendas residenciales con locales comerciales. Las remodelaciones más frecuentes son actualización de cocinas, baños y fachadas. Conocemos las normativas municipales de Los Guayos.',
  },
  {
    slug: 'tocuyito',
    name: 'Tocuyito',
    city: 'Tocuyito',
    citySlug: 'valencia',
    neighborhoods: 'Tocuyito Centro, La Libertad, El Carmen y Parque Valencia',
    description: 'Remodelaciones en Tocuyito, municipio Libertador de Carabobo. Casas y apartamentos con servicio profesional.',
    localInsight: 'Tocuyito, capital del municipio Libertador, tiene una mezcla de viviendas tradicionales y urbanizaciones modernas. Las casas de los años 70-80 requieren actualización completa de instalaciones eléctricas e hidrosanitarias. Ofrecemos servicio cercano desde San Diego con tiempos de desplazamiento mínimos.',
  },
  {
    slug: 'puerto-cabello',
    name: 'Puerto Cabello',
    city: 'Puerto Cabello',
    citySlug: 'valencia',
    neighborhoods: 'El Faro, La Sorpresa, Cumboto II y San Esteban',
    description: 'Remodelaciones en Puerto Cabello, Carabobo. Segunda ciudad del estado con servicio profesional de remodelaciones.',
    localInsight: 'Puerto Cabello es la segunda ciudad de Carabobo y el principal puerto de Venezuela. El clima costero exige materiales resistentes a la salinidad y humedad. Las viviendas de la zona requieren soluciones específicas de impermeabilización y anticorrosión. Viajamos semanalmente a Puerto Cabello para proyectos programados.',
  }
];
...
console.log(`\n🎉 ${count} landing pages de zonas Carabobo generadas`);
